...
smallStepE (Var x, s) = (Num (procuraVar s x), s) -- VAR

smallStepE (Soma (Num n1) (Num n2), s) = (Num (n1 + n2), s) -- SOMA3
smallStepE (Soma (Num n) e, s) = let (el,sl) = smallStepE (e,s) -- SOMA2
                                 in (Soma (Num n) el, sl)
smallStepE (Soma e1 e2,s) = let (el,sl) = smallStepE (e1,s) -- SOMA1
                            in (Soma el e2,sl)

smallStepE (Mult (Num n1) (Num n2), s) = (Num (n1 * n2), s) -- MULT3
smallStepE (Mult (Num n) e, s) = let (el,sl) = smallStepE (e,s) -- MULT2
                                 in (Mult (Num n) el, sl)
smallStepE (Mult e1 e2,s) = let (el,sl) = smallStepE (e1,s) -- MULT1
                            in (Mult el e2,sl)
...
smallStepC (DoWhile c b,s) = (Seq c (If b (DoWhile c b) (Skip)),s) -- DOWHILE
...
testeIf :: C
testeIf = (Seq (Atrib (Var "y") (Num 32)) 
               (Seq (Atrib (Var "z") (Num 5)) 
                     (If (Leq (Var "y") (Var "x")) (Atrib (Var "x") (Var "z")) (Atrib (Var "y") (Var "z")))))


testeDoWhile :: C
testeDoWhile = (Seq (Atrib (Var "x") (Num 26)) 
                     (DoWhile (Atrib (Var "x") (Mult (Var "y") (Num 7))) 
                         (Igual (Var "x") (Num 1))))